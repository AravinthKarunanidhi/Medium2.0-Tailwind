...
export default function Slug({post}:Props) {
  ...
  return (
    <main>
        <Header/>
        <img className="w-full h-40 object-cover" src={urlFor(post.mainImage).url()!}></img>
        <article className='max-w-3xl mx-auto p-5'>
            ...
            <div className='flex items-center space-x-2'>
                ...
                <p className='font-extralight text-sm'>
                    Blog post by <span className='text-green-500'>{post.author.name}</span> - Published at{" "}
        ...
        {submitted ? (
            <div className='flex flex-col py-10 my-10 bg-yellow-500 text-white max-w-2xl mx-auto'>
                <h3 className='text-3xl text-white px-5'>Thank you for submitting your comment!</h3>
                <p className='px-5'>Once it has been approved, it will appear below!</p>
            </div>
        ) : (
       ...
       <div className='flex flex-col p-10 my-10 max-w-2xl mx-auto border shadow-yellow-500 shodow space-y-2'>
